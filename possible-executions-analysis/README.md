...
В рамках данного задания я проанализировал все возможные исполнения указанной ниже программы 
...
Я нарисовал диаграмму всех возможных различных состояний исполнения программы из двух потоков **P** и **Q** в модели 
чередования операций и записал результат в файл [solution.txt](solution.txt) использовав следующую нотацию:
...
Для проверки корректности моего решения можно запустить `./gradlew build` из корня репозитория. 

Поток **P** никогда не останавливается, поэтому в этой системе не будет конечного
